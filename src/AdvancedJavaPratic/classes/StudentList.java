package AdvancedJavaPratic.classes;
...
*/
            ...
            public static void listeGrade(){
                Student<String,Double,Double> std1 = new Student("Wilma",76.8,80.0);
                Student<String,Double,Double> std2 = new Student("Fred",89.9,98.9);
            ...
            public static void listMemberLibrary(){
                Student<String,Integer,String> std1 = new Student<>("Çakıl",567,"çakıl@gmail.com");
